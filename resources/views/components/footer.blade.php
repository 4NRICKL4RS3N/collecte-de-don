<div class="container py-4 py-lg-5 footer">
    <div class="row justify-content-center">
        ...
        <div class="col-sm-4 col-md-3 text-center text-lg-start d-flex flex-column item">
            <ul class="list-unstyled">
                <li><a class="link-secondary" href="#">Politique de confidentialité</a></li>
                <li><a class="link-secondary" href="#">Conditions d'utilisation</a></li>
                <li><a class="link-secondary link" href="#">FAQ</a></li>
            </ul>
        </div>
        <div
