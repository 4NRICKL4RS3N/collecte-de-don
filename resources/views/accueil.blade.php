            ...
            <div class="row">
                <div class="col-md-8 offset-md-2">
                    <h1 class="display-4 grand-titre"><span class="bold-text">Participez</span> à notre mission
                        d'évangélisation</h1>
                    <x-button add-class="btn-primary" lien="#" content="Faites une différence aujourd'hui"/>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <ul class="splide__list">
                        ...
                        <li class="splide__slide">
                            <div class="card mb-3 slide-card" style="max-width: 540px;">
                                <div class="row g-0">
                                    <div class="col-md-4">
                                        <img src="{{ asset('images/une femme.jpg') }}" class="img-fluid rounded-start"
                                             alt="...">
                                    </div>
                                    <div class="col-md-8" style="position: relative">
                                        <h5 class="quote">“</h5>
                    ...
                    <div class="row h-100">
                        <div
                            ...
                            <div>
                                ...
                                <x-button add-class="btn-light" lien="#" content="Faire un don maintenant"/>
                            </div>
                        </div>
                    </div>
                </div>
